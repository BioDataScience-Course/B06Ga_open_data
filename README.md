...
Voici une série de conseils pour trouver des données adaptée à des analyses multivariées, le travail sur les bases de données.
...
Enfin, complétez le rapport `report.qmd`. Vous réalisez et interprétez une analyse multivariée de type SOM sur les données choisies.
